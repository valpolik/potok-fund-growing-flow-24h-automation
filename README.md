## potok-fund-growing-flow-24h-automation
potok-fund-growing-flow-24h-automation
...
- **Install** [this file](potok-fund-growing-flow-24h-automation.user.js) ("potok-fund-growing-flow-24h-automation.user.js") in your [Tampermonkey](http://tampermonkey.net) extension for your web-browser. (With Tampermonkey installed, often just clicking on [**this link**](https://github.com/valpolik/potok-fund-growing-flow-24h-automation/raw/refs/heads/main/potok-fund-growing-flow-24h-automation.user.js) is enough for install).

- Keep your window and tab with potok fund growing flow always active and opened 24/7. (Or add website into awake list in your web-browser settings like "Always keep these sites active").

- Sometimes, check for updates on **this** page (https://github.com/valpolik/potok-fund-growing-flow-24h-automation).
...
![](https://komarev.com/ghpvc/?username=potok-fund-growing-flow-24h-automation&label=Repo+views)
